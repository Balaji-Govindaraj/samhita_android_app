		...
		tel=new String[jsonArray.length()];
			...
			for(int i=0;i<jsonArray.length();i++)
			{
				...
				st[i]="S_ID:S#"+ii+"\nPhone Number:"+jsonObject.optString("phoneno").toString()+"\nYear:"+jsonObject.optString("year").toString()+"\nDepartment:"+
						...
						+jsonObject.optString("event_name").toString()+"\nRound Number:"+jsonObject.optString("roundno").toString()+" Round \n";
			...
			{
				Toast.makeText(context,"No Results Announced Yet",Toast.LENGTH_SHORT).show();
			}
		}
		catch(Exception e)
		{
